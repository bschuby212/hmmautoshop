...
export const vanParts: VanPart[] = [
  {
    ...
    imageSrc: roofRack,
    accessory: { width: '51%', x: '24.5%', y: '32.3%', anchor: 'top left' },
  ...
  },
  {
    ...
    imageSrc: bikeRack,
    accessory: { width: '13.5%', x: '8%', y: '46.4%', anchor: 'top left' },
    camera: { scale: 1.03, x: 14, y: 2, transformOrigin: '22% 55%', duration: 540 },
    beachPlacement: { width: '15%', x: '6%', y: '30%', anchor: 'top left' },
  },
  {
    id: 'solar-panels',
    name: 'Solar panels',
    ...
    accessory: { width: '53%', x: '23.5%', y: '41.6%', anchor: 'top left' },
  ...
  },
  {
    ...
    imageSrc: skiRack,
    accessory: { width: '50%', x: '25%', y: '41.4%', anchor: 'top left' },
  ...
  },
  {
    ...
    accessory: { width: '47%', x: '25.5%', y: '35%', anchor: 'top left' },
  ...
  },
  {
    ...
    accessory: { width: '6.6%', x: '82.2%', y: '54.3%', anchor: 'top left' },
    camera: { scale: 1.03, x: -14, y: -2, transformOrigin: '80% 56%', duration: 540 },
    beachPlacement: { width: '7.5%', x: '81.5%', y: '43%', anchor: 'top left' },
  },
  {
    id: 'eyelashes',
    name: 'Eyelashes',
    ...
    imageSrc: eyelashes,
    accessory: { width: '7.2%', x: '83.5%', y: '52.6%', anchor: 'top left' },
    camera: { scale: 1.03, x: -16, y: 0, transformOrigin: '82% 54%', duration: 540 },
    beachPlacement: { width: '8%', x: '82.8%', y: '41%', anchor: 'top left' },
  },
  {
    id: 'mustache',
    name: 'Mustache',
    ...
    imageSrc: mustache,
    accessory: { width: '9.2%', x: '83.2%', y: '61%', anchor: 'top left' },
    camera: { scale: 1.03, x: -14, y: -6, transformOrigin: '80% 62%', duration: 540 },
    beachPlacement: { width: '10%', x: '82%', y: '53%', anchor: 'top left' },
  },
  {
    id: 'mustache-front',
    name: 'Front mustache',
    ...
    accessory: { width: '12%', x: '81.2%', y: '60.8%', anchor: 'top left' },
    camera: { scale: 1.03, x: -12, y: -6, transformOrigin: '80% 62%', duration: 540 },
    beachPlacement: { width: '13%', x: '80%', y: '53%', anchor: 'top left' },
  },
  {
    id: 'kayak',
    name: 'Kayak',
    ...
    imageSrc: kayak,
    accessory: { width: '53%', x: '23.5%', y: '38.5%', anchor: 'top left' },
  ...
  },
  {
    ...
    accessory: { width: '38%', x: '31%', y: '69%', anchor: 'top left' },
