 ...
 *
 * Camera keeps scale near 1 so accessory swipes are gentle pans, not hard zooms.
 * Placement values are percentages of the van stage box.
 *
...
export const vanParts: VanPart[] = [
  {
    ...
    imageSrc: roofRack,
    accessory: { width: '51%', x: '24.5%', y: '35.2%', anchor: 'top left' },
    camera: { scale: 1, x: 0, y: 0, transformOrigin: '50% 52%', duration: 380 },
  ...
  },
  {
    ...
    camera: { scale: 1, x: 6, y: 0, transformOrigin: '28% 55%', duration: 400 },
  ...
  },
  {
    ...
    camera: { scale: 1, x: 0, y: 2, transformOrigin: '50% 44%', duration: 380 },
  ...
  },
  {
    ...
    camera: { scale: 1, x: -2, y: 2, transformOrigin: '48% 44%', duration: 380 },
  ...
  },
  {
    ...
    camera: { scale: 1, x: 2, y: 2, transformOrigin: '50% 42%', duration: 390 },
  ...
  },
  {
    ...
    accessory: { width: '6.6%', x: '79.8%', y: '54.6%', anchor: 'top left' },
    camera: { scale: 1, x: -6, y: -1, transformOrigin: '78% 56%', duration: 400 },
  ...
  },
  {
    ...
    camera: { scale: 1, x: -7, y: 0, transformOrigin: '80% 54%', duration: 400 },
  ...
  },
  {
    ...
    camera: { scale: 1, x: -6, y: -2, transformOrigin: '78% 62%', duration: 400 },
  ...
  },
  {
    ...
    camera: { scale: 1, x: -5, y: -2, transformOrigin: '78% 62%', duration: 400 },
  ...
  },
  {
    ...
    camera: { scale: 1, x: 0, y: -3, transformOrigin: '50% 68%', duration: 380 },
