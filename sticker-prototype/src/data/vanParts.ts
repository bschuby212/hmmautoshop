...
export const vanParts: VanPart[] = [
  {
    ...
    imageSrc: roofRack,
    accessory: { width: '54%', x: '23%', y: '39%', anchor: 'top left' },
  ...
  },
  {
    ...
    imageSrc: bikeRack,
    accessory: { width: '15%', x: '4%', y: '46%', anchor: 'top left' },
    camera: { scale: 1.04, x: 16, y: 2, transformOrigin: '22% 55%', duration: 500 },
    beachPlacement: { width: '16%', x: '3%', y: '30%', anchor: 'top left' },
  },
  {
    id: 'solar-panels',
    name: 'Solar panels',
    ...
    accessory: { width: '56%', x: '22%', y: '40%', anchor: 'top left' },
  ...
  },
  {
    ...
    imageSrc: skiRack,
    accessory: { width: '52%', x: '24%', y: '39.5%', anchor: 'top left' },
